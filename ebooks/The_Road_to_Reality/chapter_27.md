...
## 27.1 动力学演化的时间对称性 { .tutor-section }
...
定律的确应当用于未来方向。大体上说，这个结论与我们对宇宙在过去方向上的实际观察不相符，见[图 27.7](assets/page520_fig01.jpg)。
...
![图27.7 熵 $S$ 随时间 $t$ 变化的曲线图，显示"外推情形"虚线（向过去熵持续增大）与"实际情形"实线（过去熵反而较小）的对比，标注"现在"时刻。](assets/page520_fig01.jpg)
...
## 27.6 整个宇宙可看作一个“孤立系统”吗？ { .tutor-section }
...
## 27.13 异乎寻常的特殊大爆炸 { .tutor-section }
