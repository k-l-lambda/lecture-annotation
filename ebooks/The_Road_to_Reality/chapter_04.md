...
为结束本章，让我们来看看另一种类型的收敛/发散问题。这就是我们在 [§1.3](chapter_01.md#13-柏拉图的数学世界真实吗) 和图 1.2 描述的所谓曼德布罗特集这样一种异乎寻常的基础结构。实际上，这只是韦塞尔复平面的一个子集，它可以以一种相当简单的方式来定义，尽管这个集合看上去极为复杂。我们要做的就是检验下列代换的重复应用：
