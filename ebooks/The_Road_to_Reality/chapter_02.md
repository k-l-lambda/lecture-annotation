...
这里 $R$ 是边界圆半径，$r_c$ 是从共形表示中一点的边界圆的中心向外的欧几里得距离（图2.15）。$^{*〔2.4〕}$ 图2.16是按此公式将[图2.11](assets/page042_fig01.jpg)的埃舍尔的画从共形表示变换到射影表示下的图形。（尽管忽略了细节，埃舍尔的那种精确的艺术特点仍十分明显。）虽然不是那么吸引人，但它提供了一个全新的视角！
