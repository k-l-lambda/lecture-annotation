...
我们也可将这个方程写成 $(\mathbf{T} - \lambda\mathbf{I})\mathbf{v} = 0$，这样，如果λ是**T**的本征值，则量**T** − λ**I**必为奇异的。反之，若**T** − λ**I**为奇异的，则λ必为**T**的本征值。注意，若**v**是本征矢量，则**v**的非零复数倍也是本征矢量。这些乘积矢量的一维复空间在变换**T**下是不变的，这是**v**作为本征矢量的一种性质（图13.10）。
