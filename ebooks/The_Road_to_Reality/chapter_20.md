...
## 20.1 神奇的拉格朗日形式体系 { .tutor-section }
...
振动系统的一个简单例子是通常在重力下振荡的单摆。如果振幅很小，则摆锤的运动可视为正弦波的时间函数（[图20.6](assets/page366_fig01.jpg)）（这是我们在[§9.1](chapter_09.md#91-傅里叶级数-153)就遇到过的单一的“傅立叶分量”的性态。）对于小振子，振动周期实际上与振幅（即摆锤摆过的距离）无关——这是伽利略1583年就观察得出的一个结果。这种运动称为简谐运动。
...
## 20.6 如何从拉格朗日量导出现代理论 { .tutor-section }
