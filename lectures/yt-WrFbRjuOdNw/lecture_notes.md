...
## 段落 1：课程引入与洛伦兹坐标、基矢和度规 { #段落-1 .tutor-section }
...
## 段落 2：逆变与协变分量、升降指标和指标体操 { #段落-2 .tutor-section }
...
## 段落 3：抽象命名记号与相对论物理公式表达 { #段落-3 .tutor-section }
...
## 段落 4：洛伦兹参考系下的粒子动力学与三加一分解 { #段落-4 .tutor-section }
