...
## 段落 1：课程引入与卡西米尔算符的作用 { #段落-1 .tutor-section }
...
## 段落 2：加当生成元J3与基态标签的建立 { #段落-2 .tutor-section }
...
## 段落 3：升降算符、最高最低权与J的量子化 { #段落-3 .tutor-section }
...
## 段落 4：归一化系数的求解与标准记号|j,m⟩ { #段落-4 .tutor-section }
...
## 段落 5：从平凡表示到二维表示的显式矩阵构造 { #段落-5 .tutor-section }
...
## 段落 6：三维表示、一般结论与课程总结 { #段落-6 .tutor-section }
