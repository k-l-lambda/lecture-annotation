...
## 段落 1：引入主题：空间反演与左右手旋量的互换 { #段落-1 .tutor-section }
...
## 段落 2：狄拉克旋量、马约拉纳旋量及其宇称变换 { #段落-2 .tutor-section }
...
## 段落 3：电荷共轭：手征转换与反粒子的物理意义 { #段落-3 .tutor-section }
...
## 段落 4：从有限维到无穷维：场的洛伦兹表示与生成元 { #段落-4 .tutor-section }
...
## 段落 5：平移生成元、庞加莱群引入与课程总结 { #段落-5 .tutor-section }
