...
## 段落 1：课程引入与范德瓦尔登记号的基本定义 { #段落-1 .tutor-section }
...
## 段落 2：旋量度规Epsilon、复共轭与左右手旋量转换 { #段落-2 .tutor-section }
...
## 段落 3：四类旋量变换规律与洛伦兹不变量构造 { #段落-3 .tutor-section }
...
## 段落 4：（1/2,1/2）表示、向量表示及课程总结 { #段落-4 .tutor-section }
