...
## 段落 1：课程导入与迪卡尔基底下的向量分量 { #段落-1 .tutor-section }
...
## 段落 2：高阶张量分量表示与槽位命名指标技法 { #段落-2 .tutor-section }
...
## 段落 3：指标语言在经典力学与量子理论中的应用 { #段落-3 .tutor-section }
...
## 段落 4：正交坐标变换、分量变换规律与自旋示例 { #段落-4 .tutor-section }
