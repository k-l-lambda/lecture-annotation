...
## 段落 1：课程引入与离散变换对生成元的作用 { #段落-1 .tutor-section }
...
## 段落 2：洛伦兹代数的对易关系与复化分解 { #段落-2 .tutor-section }
...
## 段落 3：反对称张量写法及其理括号结构 { #段落-3 .tutor-section }
...
## 段落 4：覆盖群表示、标量表示与左手旋量 { #段落-4 .tutor-section }
...
## 段落 5：旋量的物理性质、右手旋量与课程总结 { #段落-5 .tutor-section }
