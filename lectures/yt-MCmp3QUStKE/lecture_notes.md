...
## 段落 1：庞加莱群的定义、生成元与代数结构 { #段落-1 .tutor-section }
...
## 段落 2：卡西米尔算符的思路与第一个不变量：质量平方 { #段落-2 .tutor-section }
...
## 段落 3：第二个卡西米尔算符、泡利-卢班斯矢量与自旋 { #段落-3 .tutor-section }
...
## 段落 4：不可约表示与基本粒子：质量、自旋及场的对应 { #段落-4 .tutor-section }
