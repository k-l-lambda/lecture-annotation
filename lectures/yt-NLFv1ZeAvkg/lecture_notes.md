...
## 段落 1：引入分布函数与等离子体相空间描述 { #段落-1 .tutor-section }
...
## 段落 2：光子的比强度、相空间体积与参考系不变量 { #段落-2 .tutor-section }
...
## 段落 3：态密度与平均占据数：连接经典和量子 { #段落-3 .tutor-section }
...
## 段落 4：习题应用：估算光子与引力子的平均占据数 { #段落-4 .tutor-section }
