...
## 段落 1：从三维旋转矩阵引出四元数 { #段落-1 .tutor-section }
...
## 段落 2：四元数的乘法规则与SU(2)矩阵表示 { #段落-2 .tutor-section }
...
## 段落 3：用四元数作用三维向量并发现半角关系 { #段落-3 .tutor-section }
...
## 段落 4：SU(2)对SO(3)的双覆盖及其物理启示 { #段落-4 .tutor-section }
