...
## 段落 1：课程引入：四维体积积分与向量三面积的定义 { #段落-1 .tutor-section }
...
## 段落 2：向量三面积的几何意义、取向与积分构造 { #段落-2 .tutor-section }
...
## 段落 3：四维高斯定理与电荷守恒的全局到局部表述 { #段落-3 .tutor-section }
...
## 段落 4：其他守恒流、流体应用与习题总结 { #段落-4 .tutor-section }
