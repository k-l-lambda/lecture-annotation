...
## 段落 1：课程引入与洛伦兹群的定义条件 { #段落-1 .tutor-section }
...
## 段落 2：洛伦兹变换的四类划分与固有正时群 { #段落-2 .tutor-section }
...
## 段落 3：四维矩阵表示与旋转、Boost生成元构造 { #段落-3 .tutor-section }
...
## 段落 4：由生成元得到有限Boost变换及全课总结 { #段落-4 .tutor-section }
