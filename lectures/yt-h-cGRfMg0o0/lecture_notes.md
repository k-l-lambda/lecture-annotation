...
## 段落 1：课程引入与无坐标系下的张量代数基础 { #段落-1 .tutor-section }
...
$$\mathbf{g}(\vec{A}, \vec{B}) \equiv \vec{A} \cdot \vec{B}$$
...
这段内容为后续学习**弯曲时空中的广义相对论**奠定了关键的语言基础——在那里，度规 $\mathbf{g}$ 本身成为动力学变量，而"无坐标系"的思维方式将变得不可或缺。

---

## 段落 2：固有时、世界线与四速度四动量 { #段落-2 .tutor-section }
...
## 段落 3：四动量守恒、四力与洛伦兹力的几何推导 { #段落-3 .tutor-section }
...
## 段落 4：课程总结与练习：反对称张量和标量引力模型 { #段落-4 .tutor-section }
