...
## 段落 1：课程引入与洛伦兹变换的基矢、指标约定 { #段落-1 .tutor-section }
...
## 段落 2：矩阵逆、转置与指标升降规则 { #段落-2 .tutor-section }
...
## 段落 3：洛伦兹变换的不变性条件与纯Boost公式 { #段落-3 .tutor-section }
...
## 段落 4：时空图、同时性与时间膨胀长度收缩 { #段落-4 .tutor-section }
...
## 段落 5：双生子佯谬、实验验证与虫洞时间旅行 { #段落-5 .tutor-section }
