...
## 段落 1：课程引入与四维时空中的世界线参数化 { #段落-1 .tutor-section }
...
## 段落 2：动量空间、质量双曲面与相空间定义 { #段落-2 .tutor-section }
...
## 段落 3：证明相空间体积元与分布函数的洛伦兹不变性 { #段落-3 .tutor-section }
...
## 段落 4：质量分布情形的推广与课程总结 { #段落-4 .tutor-section }
