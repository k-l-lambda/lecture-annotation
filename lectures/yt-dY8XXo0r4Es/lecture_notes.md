...
## 段落 1：课程引入与李代数的抽象定义 { #段落-1 .tutor-section }
...
## 段落 2：SU(2) 的生成元、泡利矩阵与李代数结构 { #段落-2 .tutor-section }
...
## 段落 3：李群的流形观点与单连通覆盖群 { #段落-3 .tutor-section }
...
## 段落 4：表示论基础、不可约表示及课程总结 { #段落-4 .tutor-section }
